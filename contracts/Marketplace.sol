    ...
    IERC721Receiver
{
    ...
    */
    ...
    function purchaseSale(uint256 saleId) external nonReentrant {
        ...
        bool feeReceiverTxSuccess = howl.transferFrom(
            msg.sender,
            feeReceiver,
        ...
        // transfer to seller
        bool sellerTxSuccess = howl.transferFrom(
            msg.sender,
            sale.seller,
    ...
    /* Returns all active sales by page and size */
    ...
    function getUserNFTs() external view returns (TokenInfo[] memory) {
        ...
        for (uint256 i = 0; i < balance; i++) {
            ...
            tokens[i] = TokenInfo(tokenId, address(nft), uri);
        }
