...
export default function SelectWalletModal({ open = true, onClose = () => null }) {
      ...
      <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={onClose} >
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <Dialog.Overlay className="fixed inset-0 bg-black bg-opacity-75 transition-opacity" onClick={onClose} />
          </Transition.Child>
                ...
                <div className="mt-3 text-center sm:mt-5">
                  ...
                  <div className="mt-4">
                    <p className="text-lg text-white">
                      ...
                      <br/>
                      <a href={'https://www.howlcity.io/'} className="text-blue-600 mt-2" >Terms of Service.</a>
                    </p>
                  </div>
                </div>
              </div>
