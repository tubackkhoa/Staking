...
```bash
npx hardhat mint [--quantity 5] [--addresss 0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266] --network localhost # default quantity 1, will mint NFT for signer 0 in default
```
